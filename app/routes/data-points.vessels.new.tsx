...
export const meta: MetaFunction = () => {
  return [
    { title: "New Vessel - Cargo Care" },
    { name: "description", content: "Create a new vessel" },
  ];
};
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return Response.json({ error: "Failed to create vessel" }, { status: 500 });
  }
}
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-xl font-semibold text-gray-900">New Vessel</h1>
                <p className="mt-1 text-sm text-gray-600">Add a new vessel to the system</p>
              </div>
              <Link
