...
export const meta: MetaFunction = () => {
  return [
    { title: "Edit Organization - Cargo Care" },
          ...
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">Update organization details</p>
              </div>
              <Link
              ...
              <div className="mt-2 space-y-2">
                <div className="flex items-center">
                  <input
                    ...
                    value="true"
                    defaultChecked={organization.orgTypes.includes("Shipper")}
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value="true"
                    defaultChecked={organization.orgTypes.includes("Customer")}
                    className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value="true"
                    defaultChecked={organization.orgTypes.includes("Consignee")}
                    className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
                ...
                <div className="flex items-center">
                  <input
                    ...
                    value="true"
                    defaultChecked={organization.orgTypes.includes("Consolidators")}
                    className="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
