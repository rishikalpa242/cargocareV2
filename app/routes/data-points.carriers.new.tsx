...
export const meta: MetaFunction = () => {
  return [
    { title: "New Carrier - Cargo Care" },
    { name: "description", content: "Create a new carrier" },
  ];
};
...
export async function action({ request }: ActionFunctionArgs) {
  ...
  try {
    ...
    return Response.json({ error: "Failed to create carrier" }, { status: 500 });
  }
}
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-xl font-semibold text-gray-900">New Carrier</h1>
                <p className="mt-1 text-sm text-gray-600">Add a new carrier to the system</p>
              </div>
              <Link
